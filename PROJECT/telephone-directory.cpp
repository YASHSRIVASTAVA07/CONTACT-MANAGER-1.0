...
int main()
{
	...
	cout << "_____________________________ Please Sign-In or Sign-Up to Continue _________________________\n\n\t1._____________________________ Sign-In to an Existing Account _______________________\n\t2._____________________________ Create a new Account _________________________________\n\t3._____________________________ Exit _________________________________________________\n";
