...
void Delete()
{
    ...
    cout << "\n\n\t\t-----------////// DELETEING CONTACT INFORMATION ///////-------------\n\n";
	cout << "\n\n\t\t_____________________ ONCE DELETED IT CANNOT BE RECOVERED _____________________\n\n";
...
int main()
{
	...
	dkj:
	system("cls");
	cout << "\n\n\t\t///////////////////////////////////////WELLCOME TO CONTACT SAVER 1.0///////////////////////////////////////\n\n";
	cout << "_____________________________ Please Sign-In or Sign-Up to Continue ___________________________\n\n\t1._____________________________ Sign-In to an Existing Account ___________________________\n\t2._____________________________ Create a new Account ________________________________\n\t3._____________________________ Exit _________________________________________________\n";
